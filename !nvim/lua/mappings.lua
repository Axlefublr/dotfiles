...
local visual_pending_mappings = {
	['|'] = [[<Cmd>require('various-textobjs').column('inner')<CR>]],
	['iH'] = [[<Cmd>require('various-textobjs').mdEmphasis('inner')<CR>]],
	['aH'] = [[<Cmd>require('various-textobjs').mdEmphasis('outer')<CR>]],
	['ii'] = [[<Cmd>require('various-textobjs').indentation('inner','inner')<CR>]],
	['ai'] = [[<Cmd>require('various-textobjs').indentation('outer','inner')<CR>]],
	['iI'] = [[<Cmd>require('various-textobjs').indentation('inner','inner')<CR>]],
	['aI'] = [[<Cmd>require('various-textobjs').indentation('outer','outer')<CR>]],
	['iD'] = [[<Cmd>require('various-textobjs').doubleSquareBrackets('inner')<CR>]],
	['aD'] = [[<Cmd>require('various-textobjs').doubleSquareBrackets('outer')<CR>]],
	['R'] = [[<Cmd>require('various-textobjs').restOfIndentation()<CR>]],
	['ie'] = [[<Cmd>require('various-textobjs').entireBuffer()<CR>]],
	['.'] = [[<Cmd>require('various-textobjs').nearEoL()<CR>]],
	['iv'] = [[<Cmd>require('various-textobjs').value('inner')<CR>]],
	['av'] = [[<Cmd>require('various-textobjs').value('outer')<CR>]],
	['ik'] = [[<Cmd>require('various-textobjs').key('inner')<CR>]],
	['ak'] = [[<Cmd>require('various-textobjs').key('outer')<CR>]],
	['iu'] = [[<Cmd>require('various-textobjs').number('inner')<CR>]],
	['au'] = [[<Cmd>require('various-textobjs').number('outer')<CR>]],
	['gl'] = [[<Cmd>require('various-textobjs').url()<CR>]],
	['il'] = [[<Cmd>require('various-textobjs').lineCharacterwise('inner')<CR>]],
	['al'] = [[<Cmd>require('various-textobjs').lineCharacterwise('outer')<CR>]],
	['iC'] = [[<Cmd>require('various-textobjs').mdFencedCodeBlock('inner')<CR>]],
	['aC'] = [[<Cmd>require('various-textobjs').mdFencedCodeBlock('outer')<CR>]],
	['i|'] = [[<Cmd>require('various-textobjs').shellPipe('inner')<CR>]],
	['a|'] = [[<Cmd>require('various-textobjs').shellPipe('outer')<CR>]],
}
