...
abbrev-alias gmanpf='git commit --amend --no-edit && git push --force-with-lease'
...
abbrev-alias gamapf='git add . && git commit --amend && git push --force-with-lease'
abbrev-alias gamanpf='git add . && git commit --amend --no-edit && git push --force-with-lease'
...
abbrev-alias grs='git reset --soft'
abbrev-alias grh='git reset --hard'
abbrev-alias gst='git stash'
abbrev-alias gstp='git stash push'
abbrev-alias gsts='git stash show'
abbrev-alias gsta='git stash apply'
abbrev-alias gsto='git stash pop'
