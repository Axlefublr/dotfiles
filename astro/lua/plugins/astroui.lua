	...
	opts = {
		...
		highlights = {
			init = {
				...
				['YellowAndUndercurl'] = { fg = Colors.yellow, undercurl = true },
				['YellowBackground'] = { fg = Colors.level, bg = Colors.yellow },
				['YellowBoldBackground'] = { fg = Colors.level, bg = Colors.yellow, bold = true },
				['YellowBoldOnDark12'] = { fg = Colors.yellow, bg = Colors.dark12, bold = true },
				['YellowOnDark12'] = { fg = Colors.yellow, bg = Colors.dark12 },
				...
				['BlushOnDark13'] = { fg = Colors.blush, bg = Colors.dark13 },
				['BlushUndercurl'] = { sp = Colors.blush, undercurl = true },
				['BlushAndUnderline'] = { fg = Colors.blush, underline = true },
