local function fg(colorname) return { fg = env.color[colorname] } end

local function bg(colorname) return { bg = env.color[colorname] } end
	...
	opts = {
		...
		highlights = {
			init = {
				...
				['RedBold'] = { fg = env.color.red, bold = true },
				['OrangeBold'] = { fg = env.color.orange, bold = true },
				['YellowBold'] = { fg = env.color.yellow, bold = true },
				['GreenBold'] = { fg = env.color.green, bold = true },
				['AquaBold'] = { fg = env.color.mint, bold = true },
				['BlueBold'] = { fg = env.color.cyan, bold = true },
				['PurpleBold'] = { fg = env.color.purple, bold = true },
				['BlushBold'] = { fg = env.color.blush, bold = true },

				['RedItalic'] = { fg = env.color.red, italic = true },
				['OrangeItalic'] = { fg = env.color.orange, italic = true },
				['YellowItalic'] = { fg = env.color.yellow, italic = true },
				['GreenItalic'] = { fg = env.color.green, italic = true },
				['AquaItalic'] = { fg = env.color.mint, italic = true },
				['BlueItalic'] = { fg = env.color.cyan, italic = true },
				['PurpleItalic'] = { fg = env.color.purple, italic = true },
				...
				['OrangeBoldOnDark12'] = { fg = env.color.orange, bg = env.color.dark12, bold = true },

				['YellowAndUndercurl'] = { fg = env.color.yellow, undercurl = true },
				['YellowBackground'] = { fg = env.color.level, bg = env.color.yellow },
				['YellowBoldBackground'] = { fg = env.color.level, bg = env.color.yellow, bold = true },
				['YellowBoldOnDark12'] = { fg = env.color.yellow, bg = env.color.dark12, bold = true },
				['YellowOnDark12'] = { fg = env.color.yellow, bg = env.color.dark12 },
				['YellowOnDark13'] = { fg = env.color.yellow, bg = env.color.dark13 },
				['YellowUndercurl'] = { sp = env.color.yellow, undercurl = true },

				['AquaAndUnderline'] = { fg = env.color.mint, underline = true },
				['AquaBoldBackground'] = { fg = env.color.level, bg = env.color.mint, bold = true },
				['AquaUndercurl'] = { sp = env.color.mint, undercurl = true },

				['PurpleAndUnderline'] = { fg = env.color.purple, underline = true },

				['BlushBackground'] = { fg = env.color.level, bg = env.color.blush },
				['BlushBoldBackground'] = { fg = env.color.level, bg = env.color.blush, bold = true },
				['BlushOnDark13'] = { fg = env.color.blush, bg = env.color.dark13 },
				['BlushUndercurl'] = { sp = env.color.blush, undercurl = true },
				['BlushAndUnderline'] = { fg = env.color.blush, underline = true },
