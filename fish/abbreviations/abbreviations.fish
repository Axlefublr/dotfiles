...
abbr -a cl 'clorange'
abbr -a xrestart 'killall xremap ; xremap --mouse --watch ~/prog/dotfiles/xremap/config.yml &> /dev/null & disown'
...
abbr -a teranki 'shuf -en 1 bosses default furniture hooks items mobs npc potions shimmer'
