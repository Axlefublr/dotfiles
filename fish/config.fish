...
abbr -a ga      'git add'
abbr -a gae     'git add -e'
abbr -a gap     'clear -x ; git status -s ; git add -p ; clear -x'
abbr -a gaa     'git add .'
...
abbr -a cawa  'cargo watch'
abbr -a cachh 'cargo watch -qcx clippy -x fmt -d 0 --poll'
abbr -a cau   'cargo update'
abbr -a caf   'cargo fmt'
abbr -a cafi  'cargo fix'
abbr -a cai   'cargo init'
abbr -a cast  'cargo install'
abbr -a caun  'cargo uninstall'
abbr -a caqst 'cargo quickinstall'
