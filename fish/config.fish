...
abbr -a gmapf   'git commit --amend && git push -f && clear -x'
abbr -a gman    'git commit --amend --no-edit'
abbr -a gmanp   'git commit --amend --no-edit && git push && clear -x'
abbr -a gmanpf  'git commit --amend --no-edit && git push -f && clear -x'
abbr -a gmp     'git commit && git push && clear -x '
abbr -a gmmp    'git commit -m "" && git push && clear -x'
abbr -a gam     'git add . && git commit -a'
abbr -a gamm    'git add . && git commit -am ""'
abbr -a gamp    'git add . && git commit -a && git push && clear -x'
abbr -a gampf   'git add . && git commit -a && git push -f && clear -x'
abbr -a gammp   'git add . && git commit -am "" && git push && clear -x'
abbr -a gamap   'git add . && git commit -a --amend && git push && clear -x'
abbr -a gamanp  'git add . && git commit -a --amend --no-edit && git push && clear -x'
abbr -a gaman   'git add . && git commit -a --amend --no-edit'
abbr -a gamapf  'git add . && git commit -a --amend && git push -f && clear -x'
abbr -a gamanpf 'git add . && git commit -a --amend --no-edit && git push -f && clear -x'
abbr -a gp      'git push && clear -x'
abbr -a gpd     'git push origin --delete'
abbr -a gpf     'git push -f && clear -x'
abbr -a gpu     'git push -u origin (git branch --show-current) && clear -x'
abbr -a gcr     'git add . && git commit -m "first commit" && git push -u origin main && clear -x'
