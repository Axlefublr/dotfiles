...
set -gx EDITOR 'nvim'
set -gx VISUAL 'nvim'
set -gx PATH "$HOME/.cargo/bin" "$HOME/.cargo/env" "$HOME/.local/bin" "/mnt/c/Programming/dotfiles/fish" "/mnt/c/Programming/dotfiles/fish/functions" "/mnt/c/Programming/dotfiles/fish/setup" $PATH
