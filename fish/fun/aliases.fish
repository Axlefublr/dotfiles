...
alias --save etg 'propose.rs etg-active-items 50% ~/.local/share/magazine/Etg-active-items.txt' >/dev/null
alias --save fc 'cat ~/fes/foe/pswds/sudo | sudo -S systemctl restart fancontrol' >/dev/null
