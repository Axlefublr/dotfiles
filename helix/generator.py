...
normal_select_mappings: dict[str, Any] = {
    **disable(['B', 'P', 'R', 'V', 'Y', 'b', 'p', 'y', 'C', '\\', 'z']),
    ...
    'C-e': ['ensure_selections_forward', 'flip_selections', 'extend_prev_word_start'],
    'C-f': ['ensure_selections_forward', 'extend_next_word_end'],
    'C-5': ['ensure_selections_forward', 'flip_selections', 'extend_next_word_start'],
    'C-1': ['ensure_selections_forward', 'extend_prev_word_end'],
    'S-A-F8': ['ensure_selections_forward', 'flip_selections', 'extend_prev_long_word_start'],
    'S-A-F7': ['ensure_selections_forward', 'extend_next_long_word_end'],
    'S-A-F10': ['ensure_selections_forward', 'flip_selections', 'extend_next_long_word_start'],
    'S-A-F9': ['ensure_selections_forward', 'extend_prev_long_word_end'],
    # [[sort on]]
    ...
    'm': {
        # [[sort on]]
        # 'd': 'shell_append_output',
        # 's': 'shell_insert_output',
        # 'x': ['yank_joined', ':new', 'paste_before', ':amnesia', 'select_all', 'split_selection_on_newline'],
...
normal_mappings: dict[str, Any] = {
    ...
    'l': 'move_char_right',
    # [[sort off]]
    'L': "@'lllllllllllllllmfw",
    'H': "@'hhhhhhhhhhhhhhhmfw<C-v>r",
