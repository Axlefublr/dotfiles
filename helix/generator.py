...
normal_select_mappings: dict[str, Any] = {
    ...
    'space': {
        ...
        'H': ':sh footclient -D %(buffer_parent) lazygit 2>/dev/null',
        'I': 'harp_register_set',
        'J': 'command_palette',
        'K': 'harp_search_set',
        'L': 'workspace_symbol_picker',
        'M': ':sh footclient -D %(buffer_parent) yazi 2>/dev/null',
        ...
        'h': ':sh footclient -D %(working_directory) lazygit 2>/dev/null',
        'i': 'harp_register_get',
        'j': 'global_search',
        'k': 'harp_search_get',
        'l': 'symbol_picker',
        'm': ':sh footclient -D %(working_directory) yazi 2>/dev/null',
