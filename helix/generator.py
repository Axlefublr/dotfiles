...
normal_select_mappings: dict[str, Any] = {
    **disable(['B', 'P', 'R', 'V', 'Y', 'b', 'p', 'y', 'C', '\\', 'z', 'A-i', 'A-o']),
    # [[sort on]]
    ...
    'C-w': ['ensure_selections_forward', 'flip_selections', 'extend_char_left'],
    'C-r': ['ensure_selections_forward', 'extend_char_right'],
    'W': ['ensure_selections_forward', 'flip_selections', 'extend_char_right'],
    'R': ['ensure_selections_forward', 'extend_char_left'],
    # --------------------semantic movement--------------------
    '(': 'goto_prev_change',
    ')': 'goto_next_change',
    '²': 'goto_last_change',
