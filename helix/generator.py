...
normal_select_mappings: dict[str, Any] = {
    **disable(
    ...
    'C-h': ['ensure_selections_forward', 'flip_selections', 'extend_char_left'],
    'C-j': 'copy_selection_on_next_line',
    'C-k': 'copy_selection_on_prev_line',
    'C-l': ['ensure_selections_forward', 'extend_char_right'],
    'C-left': ['ensure_selections_forward', 'flip_selections', 'extend_char_right'],
    'C-m': 'merge_selections',
    'C-n': 'save_selection',
    'C-q': ':cd ..',
    'C-right': ['ensure_selections_forward', 'extend_char_left'],
    'C-x': 'join_selections',
