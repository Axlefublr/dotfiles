...
select_mappings: dict[str, Any] = {
    # [[sort on]]
    ',': 'normal_mode',
    '!': ['ensure_selections_forward', 'extend_prev_long_word_end'],
    '%': ['ensure_selections_forward', 'flip_selections', 'extend_next_long_word_start'],
    '1': ['ensure_selections_forward', 'extend_prev_word_end'],
    '5': ['ensure_selections_forward', 'flip_selections', 'extend_next_word_start'],
    ...
    'E': ['ensure_selections_forward', 'flip_selections', 'extend_prev_long_word_start'],
    'F': ['ensure_selections_forward', 'extend_next_long_word_end'],
    'V': 'replace',
    '`': 'switch_case',
    'e': ['ensure_selections_forward', 'flip_selections', 'extend_prev_word_start'],
    'f': ['ensure_selections_forward', 'extend_next_word_end'],
    'h': 'extend_char_left',
