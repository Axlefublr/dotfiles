...
normal_select_mappings: dict[str, Any] = {
    **disable(
    ...
    'F1': ':sh footclient -D %(buffer_parent) 2>/dev/null',
    'F2': ':sh footclient -D %(working_directory) 2>/dev/null',
    'F3': ':sh footclient -D %(working_directory) yazi 2>/dev/null',
    'F5': ':sh footclient -D %(buffer_parent) yazi 2>/dev/null',
    'F8': ':sh footclient -D %(working_directory) lazygit 2>/dev/null',
    'F9': ':sh footclient -D %(buffer_parent) lazygit 2>/dev/null',
