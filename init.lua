...
-- Fixing marks
vim.keymap.set("n", "mm", '"myy')
vim.keymap.set("n", "`m", '/<C-r>m<CR>', {silent = true})
vim.keymap.set("n", "mn", '"nyy')
vim.keymap.set("n", "`n", '/<C-r>n<CR>', {silent = true})
vim.keymap.set("n", "mj", '"jyy')
vim.keymap.set("n", "`j", '/<C-r>j<CR>', {silent = true})
vim.keymap.set("n", "mk", '"kyy')
vim.keymap.set("n", "`k", '/<C-r>k<CR>', {silent = true})
vim.keymap.set("n", "ml", '"lyy')
vim.keymap.set("n", "`l", '/<C-r>l<CR>', {silent = true})