...
foot -T kanata -o environment.TIT=kanata kanata-executor.fish & disown
...
ntf_dismiss_all
foot -T finances -o environment.TIT=finances ov --status-line=false --follow-name ~/fes/nak/job-stats.txt & disown
