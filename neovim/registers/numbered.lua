...
Map({'n', 'v'}, "'0", function() numbered_get(0) end)

Map({'n', 'v'}, "<leader>1", function() numbered_set(1) end)
Map({'n', 'v'}, "<leader>2", function() numbered_set(2) end)
Map({'n', 'v'}, "<leader>3", function() numbered_set(3) end)
Map({'n', 'v'}, "<leader>4", function() numbered_set(4) end)
Map({'n', 'v'}, "<leader>5", function() numbered_set(5) end)
Map({'n', 'v'}, "<leader>6", function() numbered_set(6) end)
Map({'n', 'v'}, "<leader>7", function() numbered_set(7) end)
Map({'n', 'v'}, "<leader>8", function() numbered_set(8) end)
Map({'n', 'v'}, "<leader>9", function() numbered_set(9) end)
Map({'n', 'v'}, "<leader>0", function() numbered_set(0) end)